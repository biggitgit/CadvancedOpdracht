...
namespace CadvancedOpdracht.Migrations
{
    ...
    [Migration("20240619135044_second_migration")]
            ...
            modelBuilder.Entity("CadvancedOpdracht.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = 1,
                            Discount = 10f,
                            EndDate = new DateTime(2024, 6, 26, 15, 50, 42, 993, DateTimeKind.Local).AddTicks(5077),
                            LocationId = 1,
                            StartDate = new DateTime(2024, 6, 19, 15, 50, 42, 993, DateTimeKind.Local).AddTicks(5020)
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 2,
                            Discount = 5f,
                            EndDate = new DateTime(2024, 7, 6, 15, 50, 42, 993, DateTimeKind.Local).AddTicks(5085),
                            LocationId = 2,
                            StartDate = new DateTime(2024, 6, 29, 15, 50, 42, 993, DateTimeKind.Local).AddTicks(5083)
                        },
                        new
                        {
                            Id = 3,
                            CustomerId = 3,
                            Discount = 15f,
                            EndDate = new DateTime(2024, 7, 16, 15, 50, 42, 993, DateTimeKind.Local).AddTicks(5091),
                            LocationId = 3,
                            StartDate = new DateTime(2024, 7, 9, 15, 50, 42, 993, DateTimeKind.Local).AddTicks(5089)
                        });
                });
